...
```
cd existing_repo
git remote add origin https://gitlab.cs.washington.edu/cse481s-23wi/raspass.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.washington.edu/cse481s-23wi/raspass/-/settings/integrations)
